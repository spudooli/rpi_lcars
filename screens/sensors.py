...
class ScreenSensors(LcarsScreen):
    def setup(self, all_sprites):
        ...
        all_sprites.add(LcarsText(colours.BLUE, (165, 663), get_statusfiledata("indoorPressure")[:4], 2.2), layer=3)
        ...
        all_sprites.add(LcarsText(colours.BLUE, (249, 520), get_statusfiledata("kitchenTemperature")[:2], 2.2), layer=3)
